...
// @id              windows-aura
// @name            Windows Aura
// @description     Minimalist dark mode interface inspired by Material UI with rounded corners and opensource operation systems. Exclusive to Windows 11.
// @version         0.1
// @author          kazzkzpk
// @github          https://github.com/kazzkzpk/windows-aura
// @include         *
// @exclude         conhost.exe
// @exclude         Plex*.exe
...
// Everything SDK (voidtools, MIT) - embedded partial IPC client
...
// Everything IPC definitions (reduced)
